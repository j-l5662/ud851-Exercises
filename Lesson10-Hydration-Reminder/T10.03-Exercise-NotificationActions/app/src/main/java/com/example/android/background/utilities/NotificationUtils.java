...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_INTENT_ID = 1000;

    private static final int ACTION_DRINK_INTENT_ID = 1001;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent ignorePendingIntent = PendingIntent.getService(context, ACTION_IGNORE_INTENT_ID,
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent drinkPendingIntent = PendingIntent.getService(context,ACTION_DRINK_INTENT_ID,drinkIntent,PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,
                "Draank!", drinkPendingIntent);
        return action;
    }
