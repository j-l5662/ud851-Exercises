...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        String departureTime = format.format(info.arrivalTime);
        String arrivalTime = format.format(info.departureTime);
        ...
        long minutesuntilBoaridng = totalMinutesUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);

        String hoursMinutes = String.format("%s: %s", hoursUntilBoarding, minutesuntilBoaridng);

        mBinding.textViewBoardingInCountdown.setText(hoursMinutes);
