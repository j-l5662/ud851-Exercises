...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        //mVisualizerView.setMinSizeScale(sharedPreferences.getString(getString(R.string.pref_edit_key),getString(R.string.pref_edit_value)));
        loadEditFromPreferences(sharedPreferences);
        loadColorFromPreferences(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }
    private void loadEditFromPreferences(SharedPreferences sharedPreferences){
        float size = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_edit_key),getString(R.string.pref_edit_value)));
